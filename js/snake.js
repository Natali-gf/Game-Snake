...
export default class Snake {
	...
	startValues(){
		...
		this.xWidth = this.field._sizeCell;
		this.yHeight = 0;
	...
	// snake tail
		this.tail.forEach((elem, index) => {
			...
			context.lineWidth = 5;
			if (index == 0) {
				context.fillRect(elem.xCoordinate, elem.yCoordinate, this.field._sizeCell, this.field._sizeCell)
				context.strokeRect(elem.xCoordinate+15, elem.yCoordinate+15, this.field._sizeCell-30, this.field._sizeCell-30);
				context.strokeRect(elem.xCoordinate, elem.yCoordinate, this.field._sizeCell, this.field._sizeCell);
			} else {
				context.fillRect(elem.xCoordinate, elem.yCoordinate, this.field._sizeCell, this.field._sizeCell)
				context.fillStyle = '#40490b'
				context.fillRect(elem.xCoordinate+20, elem.yCoordinate+20, this.field._sizeCell-40, this.field._sizeCell-40);
				context.strokeRect(elem.xCoordinate+15, elem.yCoordinate+15, this.field._sizeCell-30, this.field._sizeCell-30);
				context.strokeRect(elem.xCoordinate+7.5, elem.yCoordinate+7.5, this.field._sizeCell-15, this.field._sizeCell-15);
				context.strokeRect(elem.xCoordinate, elem.yCoordinate, this.field._sizeCell, this.field._sizeCell);
			}
		})
		this.control()
	...
	control(){
		document.addEventListener("keydown", (e) => {
			if (	e.code === 'KeyW' && this.yHeight == 0 ||
				...
				this.xWidth = 0;
				this.yHeight = -this.field._sizeCell;
	...
	rules(apple, score, canvas, resetGame){
		...
		if (this.xCoordinate < 0){
			this.xCoordinate = canvas.canvasWidth - this.field._sizeCell
		} else if (this.xCoordinate >= canvas.canvasWidth){
			this.xCoordinate = 0
		}
		if (this.yCoordinate < 0 ){
			this.yCoordinate = canvas.canvasHeight - this.field._sizeCell
